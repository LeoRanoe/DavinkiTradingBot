-- Backfilled from the deployed migration ledger (version 20260913161519).
...
-- (Superseded in the same ledger by 20260913161623, which additionally hides
-- and protects the internal scanner account.)
