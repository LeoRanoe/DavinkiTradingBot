-- Backfilled from the deployed migration ledger (version 20260913161623).
...
--
-- This revision additionally protects the internal `scanner` principal: it is
-- never listed as a guest, and it can never be password-reset or deleted
-- through the guest-management functions.
