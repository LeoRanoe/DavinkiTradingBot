  ...
  return (
    <div className="space-y-6">
      ...
      <section className="space-y-3">
        <div className="flex items-center justify-between"><h2 className="text-sm font-semibold">Open</h2><Badge variant="outline">{open?.length ?? 0}</Badge></div>
